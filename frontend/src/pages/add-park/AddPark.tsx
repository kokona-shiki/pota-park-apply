    ...
    <Box sx={{ display: { xs: 'block', md: 'flex' }, gap: 2 }}>
      ...
      <Box sx={{ flex: 1, minWidth: 0, mt: { xs: 2, md: 0 } }}>
        <Box sx={{ height: 500, width: '100%', borderRadius: 1, overflow: 'hidden' }}>
          <MapContainer center={[mapCenter[0], mapCenter[1]]} zoom={mapZoom} style={{ height: '100%', width: '100%' }}>
            <MapController center={[mapCenter[0], mapCenter[1]]} onZoomChange={(zoom) => updateFormState({ mapZoom: zoom })} />
