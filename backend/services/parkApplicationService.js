...
// 审核申请
export const reviewApplication = async (reviewerId, applicationId, status, reviewNotes, rejectionReason = null) => {
  // 检查权限
...
// 创建审核提醒
export const createReviewReminder = async (userId, applicationId, reminderType, notes, remindedTo = null) => {
  // 检查权限
