...
export const normalizeCallsign = (callsign) => String(callsign || '').trim().toUpperCase();
...
// Access Token (JWT)
// -----------------
export const getAccessTokenExpiresIn = (role) => {
...
// -----------------
const generateRefreshTokenPlain = () => crypto.randomBytes(48).toString('base64url');
...
export const rotateRefreshToken = async (refreshTokenPlain, { userAgent = null, ip = null } = {}) => {
  const tokenHash = hashRefreshToken(refreshTokenPlain);
